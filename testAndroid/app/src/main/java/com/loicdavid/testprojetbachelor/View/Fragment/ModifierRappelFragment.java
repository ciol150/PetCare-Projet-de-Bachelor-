...
public class ModifierRappelFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_modifier_rappel, container, false);
    }
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        boutonRetour = view.findViewById(R.id.frag_modif_rappel_retour);
        boutonSave = view.findViewById(R.id.frag_modif_animal_save);

        editTextNom = view.findViewById(R.id.frag_modif_rappel_nom);
        editTextDescription = view.findViewById(R.id.frag_modif_rappel_description);

        editTextDate = view.findViewById(R.id.frag_modif_rappel_date);
        editTextHeure = view.findViewById(R.id.frag_modif_rappel_heure);

        notificationActive = view.findViewById(R.id.frag_modif_rappel_notification_check);

        editTextDate.setInputType(InputType.TYPE_NULL);
        editTextHeure.setInputType(InputType.TYPE_NULL);

        spinnerIntervalle_unite = view.findViewById(R.id.frag_modif_rappel_intervalle_unite);

        editTextIntervalle_nombre = view.findViewById(R.id.frag_modif_rappel_intervalle_nombre);
        ...
        editTextNom.setText(rappelModifie.nom_rappel);
        editTextDescription.setText(rappelModifie.description);
        editTextDate.setText(rappelModifie.date);
        editTextHeure.setText(rappelModifie.heure);

        notificationActive.setChecked(rappelModifie.notif_active);

        editTextIntervalle_nombre.setText(String.valueOf(rappelModifie.intervalle_nombre));



        switch(rappelModifie.intervalle_unite) {
            case ("heures"):
